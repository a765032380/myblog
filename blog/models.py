...
class News(models.Model):
    ...
    thumbnail_pic_s = models.CharField(max_length=100,verbose_name='图片地址1')
    thumbnail_pic_s02 = models.CharField(max_length=100,verbose_name='图片地址2')
    thumbnail_pic_s03 = models.CharField(max_length=100,verbose_name='图片地址3')
